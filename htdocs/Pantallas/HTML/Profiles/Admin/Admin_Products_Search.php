...
<body>
    ...
    <div class="mb-3 col-lg-10 offset-lg-1">
        <div class="row ProfileA_ContainerLists p-0 ">
            <div class="container">
                <p class="ProfileA_HeaderObjects">Resultados de la búsqueda:</p>
                <hr>
                ...
                <div class="row">
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../../../HTML/Profiles/Admin/Admin_Products_Detail.php">Armarios de Madera</a></h5>
                                <p>Descripción: Armarios de Madera, realizados en México. Se puede modificar el color,
                                    el número de cajones, etc.</p>
                                <p>Fecha de validación: <b>01/01/2023</b> </p>
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../../../HTML/Profiles/Admin/Admin_Products_Detail.php">Cofres de Madera</a></h5>
                                <p>Descripción: Cofres de Madera, realizados en París. Favor de cotizar el objeto para
                                    más información</p>
                                <p>Fecha de validación: <b>01/01/2023</b> </p>
                                <p>Validado por: <b>@Administrador</b></p>
