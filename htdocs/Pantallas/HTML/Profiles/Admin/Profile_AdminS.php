...
<body>
    ...
    <div class="row">
    <?php
        echo '<div class="ProfileA_Container col-lg-10 offset-lg-1">
    ...
    <div class="d-flex flex-column">
        ...
        <a href="../../../HTML/Profiles/Admin/Admin_edit_profile.php" class="btn ProfileC_ListButtons">Editar Perfil</a>
    </div>
</div>';
        ?>
    </div>
    ...
    <div class="mt-3 col-lg-10 offset-lg-1">
        <div class="row ProfileA_ContainerLists p-0 ">
            <div class="container">
                <p class="ProfileA_HeaderObjects">Mis productos verificados:</p>
                ...
                <div class="row">
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Admin/Admin_Products_Detail.php">Armarios de Madera</a></h5>
                                ...
                                <p>Verificado por: <b><?php echo $nombreUsuario . " ".$apellidoPaterno . " ".  $apellidoMaterno; ?></b></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Admin/Admin_Products_Detail.php">Cofres de Madera</a></h5>
                ...
                <div class="row mt-3">
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Admin/Admin_Products_Detail.php">Artilugios de Metal</a></h5>
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Admin/Admin_Products_Detail.php">Mesas para cocina acero inoxidable</a></h5>
                                <div class="">
                ...
                <div class="row mt-3">
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Admin/Admin_Products_Detail.php">Muebles estilo japones</a></h5>
                                <div class="">
