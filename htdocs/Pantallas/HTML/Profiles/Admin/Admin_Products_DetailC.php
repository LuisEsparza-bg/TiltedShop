                ...
                <div class="col-lg-4">
                    <div class="card" style="height:550px;">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <!-- Descripción -->
                            <p class="card-text">Descripción: Mesas de Madera, realizados en París. Favor de cotizar el objeto para
                                más información</p>
                            <hr>
                            ...
                            <p class="card-text"> Vendido por: <a href="../Admin/Profile_SellerA.php " class="ProfileA_AdminHL">@Vendedor</a></p>
                            ...
                            <div class="">
                                <div class="justify-content-center align-content-center d-flex">
                                    <div class="">
                                        ...
                                        class="btn Profile_ValidateProductBtn mt-0">Validar</button>
                                         <button href="#" onclick="DevalidateProduct()"
                                        class="btn Profile_DevalidateProductBtn mt-0">No validar</button>
                                    </div>
