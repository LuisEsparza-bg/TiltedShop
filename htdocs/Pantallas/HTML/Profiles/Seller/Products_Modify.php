...
<body>
   ...
   echo'
                                    ...
                                    <div class="row mb-4 ">
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="descripcionProducto"
                                                ...
                                                required>'.$productosClass->getDescripcion().'</textarea>
                                        </div>
                                        ...
                                        <div class="col-sm-6 mb-3 ">
                                            ...
                                            <input type="number" class="form-control campos-compartidos"
                                                ...
                                                value="'. $productosClass->getPrecio().'" required>
                                        </div>
                                        ...
                                        <div class="col-sm-6 mb-4 ">
                                            ...
                                            <input type="number" class="form-control campos-compartidos"
                                                ...
                                                placeholder="Ejemplo: 5000" value="' . $productosClass->getCantidad(). '" required>
                                        </div>
                                    </div>
    ...
    <script src="../../../JS/Seller/Modificacion_Producto.js"></script>
