...
<body>
    ...
    <div class="row">
        <?php
        echo '<div class="ProfileS_Container col-lg-10 offset-lg-1 p-0">
    ...
    <div class="d-flex flex-column">
        ...
        <a href="../../../HTML/Profiles/Seller/Seller_edit_profile.php" class="btn ProfileS_ItemsButton">Editar Perfil</a>
    </div>
</div>';
        ?>
    </div>
    ...
    <div class="mt-3 col-lg-10 offset-lg-1">
        <div class=" row ProfileS_ContainerLists p-0 ">
            <div class="container">
                <p class="ProfileS_HeaderObjects">Productos no cotizados agregados recientemente:</p>
