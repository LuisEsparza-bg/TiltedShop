                ...
                <div class="row">
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Seller/Products_DetailS.php">Armarios de Madera</a></h5>
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Seller/Products_DetailS.php">Cofres de Madera</a></h5>
                ...
                <div class="row mt-3">
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Seller/Products_DetailS.php">Artilugios de Metal</a></h5>
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Seller/Products_DetailS.php">Mesas para cocina acero inoxidable</a></h5>
                                <div class="">
                ...
                <div class="row mt-3">
                    ...
                    <div class=" container-fluid col-lg-6">
                        <div class="row">
                            ...
                            <div class="container-fluid col-lg-8">
                                <h5><a class="ProfileA_NameObject" href="../Seller/Products_DetailS.php">Muebles estilo japones</a></h5>
                                <div class="">
